...
function NavBarAdmin() {
  ...
  useEffect(() => {
    // Load Bootstrap CSS, JS, and Animate.css
    const loadBootstrap = () => {
            ...
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item">
                ...
                <a className="nav-link" href="/ClothingGalleryFilter">
                  <i ></i>FilterAndGetItems
                </a>
              </li>

              <li className="nav-item">
                <a className="nav-link" href="/UpdateItems">
                  <i ></i>UpdateItems
                </a>
              </li>
              ...
              <li className="nav-item">
                <a className="nav-link" href="/PaymentGraph">
                  <i ></i>SalesGraph
                </a>
              </li>
          
              <li className="nav-item">
                <a className="nav-link" href="/AdminRegister">
                  <i ></i>AdminRegister
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/ItemAdded">
                  <i ></i>AddItems
                </a>
              </li>

              <li className="nav-item">
                <a className="nav-link" href="/SoldItemsDetails">
                  <i></i>SoldItems
                </a>
              </li>
              <li className="nav-item">
